			...
			<div class="col-lg-3 col-md-3 col-sm-3">
				<article class="card">
					...
					<div class="card-block">
						...
						<a data-toggle="modal" data-target="#borrarViaje${v.idViaje }" class="btn btn-outline-danger btn-block"><i class="fa fa-trash" aria-hidden="true"></i> Borrar Viaje</a>
					</div>
				</article>
			</div>
			
 <div class="modal fade" id="borrarViaje${v.idViaje }"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ¿Estás seguro de borrar el viaje?
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary"
                                            data-dismiss="modal">No</button>
                                        <button type="button" class="btn btn-primary"
                                            onclick="location.href='<c:url value="/BorrarViaje?idViaje=${v.idViaje }"/>'">Sí</button>
                                    </div>
                                </div>
                            </div>
                        </div>
